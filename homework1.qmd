...
age_diff_over_years <- age_gaps %>%
  ...
  # Hollywood depict same-gender love interests
age_gaps <- age_gaps %>%
...
-   Who did you collaborate with: Vast majority I did pretty much completely alone (maybe a mistake), also a bit with Brent Lewis
